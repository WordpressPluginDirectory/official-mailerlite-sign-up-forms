...
= 1.7.13 =
* Fix for whitespace in JavaScript

= 1.7.12 =
* Tested with WP version 6.6

= 1.7.11 =
* Improvements about form information
...
= 1.7.6 =
* Improved custom role compatibility
...
= 1.7.3 =
* Added the ability to edit email field labels and placeholders
* Added the ability to re-order custom form fields
...
= 1.7.0 =
* Added feature to allow non admin users manage custom forms
* Bug fixes

= 1.6.13 =
* Added validations on custom forms

= 1.6.12 =
* Wordpress 6.3.1 compatibility

= 1.6.11 =
* Fixes for load more groups
* Fixes for selected group name

= 1.6.10 =
* Minor fix for accounts with less than 100 groups

= 1.6.9 =
* Completely remove jQuery

= 1.6.8 =
* Upgrade jQuery Validation to v1.19.5
* Tested with WP version 6.2
...
= 1.6.6 =
* Fix - Autoload for popup settings
* Fix - No groups error

= 1.6.5 =
* Add - Input types for fields
* Additional updates to Gutenberg edit form

= 1.6.4 =
* Fix - Edit form expired link

= 1.6.3 =
* Fix - Embedded forms not loading
* Fix - Hide forms menu when plugin is not setup
